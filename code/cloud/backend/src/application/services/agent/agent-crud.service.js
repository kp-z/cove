...
exports.AgentCrudService = void 0;
const agent_entity_1 = require("../../../domain/models/agent/agent.entity");
...
class AgentCrudService {
    ...
    eventBus;
    logger;
    constructor(agentRepository, eventBus, logger) {
    ...
    async createAgent(dto) {
        ...
        const agent = agent_entity_1.AgentEntity.create({
            agentId,
            name: dto.name,
    ...
    async updateAgent(agentId, dto) {
        ...
        const triggers = (dto.onMention !== undefined || dto.onDirectMessage !== undefined ||
            ...
            : agent.triggers;
        const updatedAgent = agent_entity_1.AgentEntity.create({
            agentId: agent.agentId,
            name: agent.name,
    ...
    async deleteAgent(agentId) {
        ...
        if (agent.status === 'active') {
            throw new agent_errors_1.AgentInUseError(agentId);
        }
...
exports.AgentCrudService = AgentCrudService;
