...
exports.serverContextStore = void 0;
exports.getRealmContext = getRealmContext;
exports.runWithContext = runWithContext;
exports.hasRealmContext = hasRealmContext;
const async_hooks_1 = require("async_hooks");
/**
 * AsyncLocalStorage 实例，用于存储当前请求的 RealmContext
 */
exports.serverContextStore = new async_hooks_1.AsyncLocalStorage();
/**
...
function getRealmContext() {
    const context = exports.serverContextStore.getStore();
    if (!context) {
        throw new Error('RealmContext is not available. ' +
...
function runWithContext(context, callback) {
    return exports.serverContextStore.run(context, callback);
}
/**
...
function hasRealmContext() {
    return exports.serverContextStore.getStore() !== undefined;
}
