...
describe('HybridTaskRepository', () => {
  ...
  describe('save', () => {
    it('should save a new task', async () => {
      ...
      const found = await runWithContext(testContext, async () => {
        return await repository.findById('task-1');
      });
    ...
    it('should save task with assignee', async () => {
      ...
      const found = await runWithContext(testContext, async () => {
        return await repository.findById('task-2');
      });
    ...
    it('should save task with dependencies', async () => {
      ...
      const found = await runWithContext(testContext, async () => {
        return await repository.findById('task-3');
      });
    ...
    it('should save task with source message', async () => {
      ...
      const found = await runWithContext(testContext, async () => {
        return await repository.findById('task-4');
      });
    ...
    it('should save task with different types', async () => {
      ...
      const foundSingle = await runWithContext(testContext, async () => {
        return await repository.findById('task-single');
      });
      const foundMulti = await runWithContext(testContext, async () => {
        return await repository.findById('task-multi');
      });
      const foundWorkflow = await runWithContext(testContext, async () => {
        return await repository.findById('task-workflow');
      });
  ...
  describe('findByProject', () => {
    it('should find tasks by project id', async () => {
      ...
      const found = await runWithContext(testContext, async () => {
        return await repository.findByProject('project-1');
      });
  ...
  describe('findByStatus', () => {
    it('should find tasks by status', async () => {
      ...
      const todoTasks = await runWithContext(testContext, async () => {
        return await repository.findByStatus('todo');
      });
      const inProgressTasks = await runWithContext(testContext, async () => {
        return await repository.findByStatus('in_progress');
      });
      const doneTasks = await runWithContext(testContext, async () => {
        return await repository.findByStatus('done');
      });
  ...
  describe('findByPriority', () => {
    it('should find tasks by priority', async () => {
      ...
      const lowTasks = await runWithContext(testContext, async () => {
        return await repository.findByPriority('P3');
      });
      const mediumTasks = await runWithContext(testContext, async () => {
        return await repository.findByPriority('P2');
      });
      const highTasks = await runWithContext(testContext, async () => {
        return await repository.findByPriority('P0');
      });
  ...
  describe('findByAssignee', () => {
    it('should find tasks by assignee id', async () => {
      ...
      const user1Tasks = await runWithContext(testContext, async () => {
        return await repository.findByAssignee('user-1');
      });
      const user2Tasks = await runWithContext(testContext, async () => {
        return await repository.findByAssignee('user-2');
      });
    ...
    it('should return empty array when assignee has no tasks', async () => {
      const found = await runWithContext(testContext, async () => {
        return await repository.findByAssignee('non-existent-user');
      });
  ...
  describe('findByKR', () => {
    it('should find tasks by KR id', async () => {
      ...
      const kr1Tasks = await runWithContext(testContext, async () => {
        return await repository.findByKR('kr-1');
      });
      const kr2Tasks = await runWithContext(testContext, async () => {
        return await repository.findByKR('kr-2');
      });
    ...
    it('should return empty array when KR has no tasks', async () => {
      const found = await runWithContext(testContext, async () => {
        return await repository.findByKR('non-existent-kr');
      });
  ...
  describe('exists', () => {
    it('should return true when task exists', async () => {
      ...
      const exists = await runWithContext(testContext, async () => {
        return await repository.exists('task-1');
      });
  ...
  describe('getNextTaskNumber', () => {
    it('should return 1 for first task in channel', async () => {
      const nextNumber = await runWithContext(testContext, async () => {
        return await repository.getNextTaskNumber('channel-1');
      });
  ...
  describe('error handling', () => {
    ...
    it('should log errors on update failure', async () => {
      ...
      await expect(
        runWithContext(testContext, async () => {
          await repository.update(task, 'realm-1');
        })
      ).rejects.toThrow();
      expect(mockLogger.error).toHaveBeenCalled();
    });
