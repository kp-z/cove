...
INSERT INTO "new_Device" ("configPath", "createdAt", "displayName", "id", "lastSeenAt", "name", "platform", "realmId", "status", "type", "updatedAt") SELECT "configPath", "createdAt", "displayName", "id", "lastSeenAt", "name", "platform", "realmId", "status", "type", "updatedAt" FROM "Device";
DROP TABLE "Device";
...
CREATE INDEX "Device_realmId_status_idx" ON "Device"("realmId", "status");
...
CREATE TABLE "new_Realm" (
    ...
    "avatarType" TEXT NOT NULL DEFAULT 'dicebear',
    "avatarSeed" TEXT,
    "avatarStyle" TEXT DEFAULT 'shapes',
    "createdAt" DATETIME NOT NULL,
    "updatedAt" DATETIME NOT NULL
);
