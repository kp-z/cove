...
import { ChannelService, CreateChannelDTO, UpdateChannelDTO } from '../../../application/services/channel/channel.service';
...
export class ChannelsController {
  ...
  async addMember(req: Request, res: Response): Promise<void> {
    try {
      ...
      const channel = await this.channelService.addMember({ channelId, memberId: memberId as string });
