    ...
    archive: publicProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        try {
          const context = RealmContext.create(ctx.realmId || 'default-server', ctx.userId || 'system');
          return await runWithContext(context, async () => {
            const server = await realmService.archiveRealm(input.realmId);
            return server.toJSON();
          });
        } catch (error: any) {
          throw mapErrorToTRPC(error);
    ...
    activate: publicProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        try {
          const context = RealmContext.create(ctx.realmId || 'default-server', ctx.userId || 'system');
          return await runWithContext(context, async () => {
            const server = await realmService.activateServer(input.realmId);
            return server.toJSON();
          });
        } catch (error: any) {
          throw mapErrorToTRPC(error);
    ...
    addMember: publicProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        try {
          ...
          return await runWithContext(context, async () => {
            const member = await realmService.addServerMember(
              input.realmId,
              input.userId,
              input.role
            );
    ...
    removeMember: publicProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        try {
          const context = RealmContext.create(input.realmId, ctx.userId || 'system');
          return await runWithContext(context, async () => {
            await realmService.removeServerMember(input.realmId, input.userId);
            return { success: true };
          });
        } catch (error: any) {
          throw mapErrorToTRPC(error);
    ...
    updateMemberRole: publicProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        try {
          const context = RealmContext.create(input.realmId, ctx.userId || 'system');
          return await runWithContext(context, async () => {
            const member = await realmService.updateRealmMemberRole(
              input.realmId,
              input.userId,
              input.role
            );
    ...
    getMembers: publicProcedure
      ...
      .query(async ({ input, ctx }) => {
        try {
          const context = RealmContext.create(input.realmId, ctx.userId || 'system');
          return await runWithContext(context, async () => {
            const members = await realmService.getServerMembers(input.realmId, {
              role: input.role,
              status: input.status,
            });
            return {
