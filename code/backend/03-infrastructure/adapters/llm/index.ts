export type { LlmAdapter, ChatMessage, GenerateParams } from './llm-adapter.interface.js';
export { AnthropicAdapter } from './anthropic-adapter.js';
export { OpenAIAdapter } from './openai-adapter.js';

import { LlmAdapter } from './llm-adapter.interface.js';
import { AnthropicAdapter } from './anthropic-adapter.js';
import { OpenAIAdapter } from './openai-adapter.js';
import type { RuntimeConfig } from '../../../02-application/interfaces/agent-config-store.interface.js';
...
export function createLlmAdapterFromConfig(runtime: RuntimeConfig): LlmAdapter {
