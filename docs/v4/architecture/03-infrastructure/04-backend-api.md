...
**相关文档**:
- [Domain Layer](./entities/README.md) - Backend Service 对应的实体定义
- [Application Layer](./02-runtime-layer.md) - Backend 调用的 Runtime 组件
- [Presentation Layer](./05-frontend-layer.md) - 调用 Backend API 的前端实现
