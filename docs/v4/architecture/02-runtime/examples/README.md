...
├── gateway.yaml                    # GatewayRuntime（OpenClaw 网关）配置示例
...
GatewayRuntime 配置文件，定义与 OpenClaw Gateway 的连接参数、同步策略、Dual-Write 配置。
...
完整的 Runtime Layer 设计文档见: `docs/v4/architecture/02-runtime-layer.md`

Entity Layer 示例文件见: `docs/v4/architecture/entities/{entity-name}/examples/`
