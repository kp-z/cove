...
Runtime Layer 是 Slock 系统的核心执行层，负责 Agent 的生命周期管理、技能执行、状态管理和持久化。
...
runtime/
├── design/              # 设计文档
│   └── runtime-layer.md # Runtime Layer 完整设计文档
└── examples/            # 示例配置和数据
    ├── daemon/          # Daemon 配置示例
...
- [Entity Layer](../entities/) - 实体定义和数据模型
- [Backend API](../backend/) - 后端 API 接口
- [Frontend Layer](../frontend/) - 前端界面层
